...
export const VAPI_PUBLIC_KEY = '15ab95c0-3760-4129-824a-0f10efc3b251'
...
export const DEMO_WEB_URL = 'https://oakridge-tartan-rebuild.vercel.app'

// Número de WhatsApp Business con prefijo, solo dígitos (ej: '34612345678').
// Mientras esté vacío, el botón flotante no se muestra.
export const WHATSAPP_NUMBER = ''

// URL de Cal.com o Calendly (ej: 'https://cal.com/taloslynx/diagnostico').
// Mientras esté vacía, el formulario funciona como hasta ahora.
